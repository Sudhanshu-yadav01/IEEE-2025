...
const ScrollStack = ({
  ...
  return (
    <div
      className={`w-full h-full overflow-y-auto overflow-x-hidden flex flex-col items-center ${className}`.trim()}
      ref={scrollerRef}
      style={{
    ...
    >
      <div className="scroll-stack-inner flex flex-col items-center  pb-[50rem] w-full">
        {children}
